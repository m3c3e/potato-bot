module Potato
  module Bot
    # Potato & Botan clients can perform requests in async way with
    ...
    # `Potato.bots_config=` for configuration.
    #
    ...
    #
    #   client = Potato::Bot::Client.new(**config, async: true)
    ...
    module Async
      ...
      class << self
        ...
        def thread_store
          Thread.current[:potato_bot_async] ||= {}
        end
      end
